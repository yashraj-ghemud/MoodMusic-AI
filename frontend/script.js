...
class MoodMusicApp {
    ...
    initializeElements() {
        ...
        this.moodTextarea = document.getElementById('moodInput');
    }
    ...
    activateMoodBox() {
        if (document.body.classList.contains('mood-box-open')) {
            this.focusMoodTextarea();
            this.scrollIntoViewSmooth(this.moodBoxSection);
            return;
        }
        ...
        if (this.moodBoxActivator) {
            this.moodBoxActivator.disabled = true;
    ...
    focusMoodTextarea() {
        if (this.moodTextarea && typeof this.moodTextarea.focus === 'function') {
            this.moodTextarea.focus({ preventScroll: true });
        }
    }
